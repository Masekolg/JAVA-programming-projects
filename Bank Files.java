...
public class CreateBankFile
{
        public static void main(String[] args)
        {
                ...
                String defaultRecord = ACCOUNT_NUMBER_FORMAT + delimiter + NAME_FORMAT + delimiter + BALANCE_FORMAT +
                ...
                try
                {
                     ...
                     while(!(acctString.equals(QUIT)))
                     {
                             ...
                             System.out.print("Account holder name for account #" + accString + " >> ");
                             name = input.nextLine();
                             StringBuilder sb = new StringBuilder(name);
                             sb.setLength(NAME_LENGTH);
                             name = sb.toString();
                             
                             System.out.print("Balance of account #" + accString + " >> ");
                             balance = input.nextDouble();
                             input.nextLine();
                             DecimalFormat df = new DecimalFormat(BALANCE_FORMAT);
                             
                             String s = accString + delimiter + name + delimiter + df.format(balance) +
                             System.getProperty("line.separator");
                             data = s.getBytes();
   ...
   public static void createEmptyFile(Path file, String s, int lines)
   {
           ...
           try
           {
                  OutputStream outputStr = new BufferedOutputStream(Files. CREATE));
